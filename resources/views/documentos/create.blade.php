            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('documentos.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <input id="documento_adjunto" class="form-control" type="file" name="documento_adjunto[]" onchange="validar_doc('documento_adjunto','mensajeError2')" accept=".pdf, .docx, .doc, .xlsx" multiple>
